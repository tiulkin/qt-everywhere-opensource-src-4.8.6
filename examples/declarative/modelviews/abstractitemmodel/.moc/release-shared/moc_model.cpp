...
static const char qt_meta_stringdata_AnimalModel[] = {
    "AnimalModel\0"
};
...
const QMetaObjectExtraData AnimalModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AnimalModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_AnimalModel,
      qt_meta_data_AnimalModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AnimalModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AnimalModel))
