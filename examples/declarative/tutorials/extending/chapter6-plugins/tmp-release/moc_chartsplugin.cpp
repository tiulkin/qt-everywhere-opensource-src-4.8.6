...
static const char qt_meta_stringdata_ChartsPlugin[] = {
    "ChartsPlugin\0"
};
...
const QMetaObjectExtraData ChartsPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ChartsPlugin::staticMetaObject = {
    { &QDeclarativeExtensionPlugin::staticMetaObject, qt_meta_stringdata_ChartsPlugin,
      qt_meta_data_ChartsPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ChartsPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChartsPlugin))
        return static_cast<void*>(const_cast< ChartsPlugin*>(this));
