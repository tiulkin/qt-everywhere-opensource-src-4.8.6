...
const QMetaObjectExtraData SplashItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SplashItem::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_SplashItem,
      qt_meta_data_SplashItem, &staticMetaObjectExtraData }
};
