...
static const char qt_meta_stringdata_ElidedLabel[] = {
    "ElidedLabel\0\0elided\0elisionChanged(bool)\0"
    "QString\0text\0bool\0isElided\0"
};
...
const QMetaObjectExtraData ElidedLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ElidedLabel::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ElidedLabel,
      qt_meta_data_ElidedLabel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ElidedLabel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ElidedLabel))
