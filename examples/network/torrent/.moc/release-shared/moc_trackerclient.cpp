...
void TrackerClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->connectionError((*reinterpret_cast< QHttp::Error(*)>(_a[1]))); break;
        ...
        case 8: _t->httpRequestDone((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData TrackerClient::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TrackerClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TrackerClient,
      qt_meta_data_TrackerClient, &staticMetaObjectExtraData }
};
