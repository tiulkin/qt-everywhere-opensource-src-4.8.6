...
const QMetaObjectExtraData PreviewFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PreviewFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_PreviewFrame,
      qt_meta_data_PreviewFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PreviewFrame::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
